...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const account = await prisma.accountPayable.findUnique({ where: { id }, include: { company: true, payments: { select: { amount: true } }, contractorSettlement: { include: { contractor: true } } } });
  if (!account) notFound();
