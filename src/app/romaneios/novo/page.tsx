...
export default async function Page({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <><PageHeader title="Novo Romaneio" description="Registre uma saída física para um único Terceirizado." action={{ label: "Voltar aos Romaneios", href: "/romaneios" }}/><Feedback {...messages}/><DeliveryNoteForm contractors={contractors} items={items} today={new Date().toISOString().slice(0, 10)}/></>;
}
