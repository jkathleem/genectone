...
O ciclo de governança é `DRAFT → APPROVED → CLOSED`. Somente DRAFT é editável; locks no Budget serializam mutações e transições. Cópias sempre nascem DRAFT. Não há reabertura, autoria ou versionamento nesta etapa.
