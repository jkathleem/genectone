...
type AllocationValue = { amount: Prisma.Decimal | string };
export function receivedAmount(allocations: AllocationValue[] = []) { return allocations.reduce((sum, item) => sum.plus(item.amount), new Prisma.Decimal(0)); }
