...
export function ProductBulkPriceForm({ products }: { products: Product[] }) {
  ...
  return <details className="panel mb-5">
    <summary className="link-button">Atualização em massa de preços</summary>
    <form action={bulkUpdateProductPrices} className="mt-4 grid gap-4">
      ...
      <p className="text-sm text-slate-500">A prévia é visual. O servidor recalcula todos os valores com Decimal antes de atualizar somente o preço atual do Produto.</p>
